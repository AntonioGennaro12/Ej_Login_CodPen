...
let nuevaClave  = "";
putQuestion(); // pone la primera pregunta
// se queda esperando texto seguido de un click y llama a la función validar
...
/**
 * Carga la pregunta según la corriente posición
 */
...
/**
 * Cuanto se han terminado todas la preguntas
 */
function done() {
...
/**
 * Valida los datos ingresados según la pregunta corriente
 */
function validate() {
...
/**
 * Muestra el progreso moviendo el background y apunta a la siguiente pregunta si la hay sino va a "done"
 */
function okFunction () {
    ok(function() {
...
// --------------
/**
 * Oculta la pregunta corriente y pone un timeout para llamar a la función pasada como parámetro 
...
/**
 * Muestra la pregunta corriente y pone un timeout para llamar a la función pasada como parámetro 
 * @param {Function} callback 
 */
...
/**
 * Ejecuta el desplazamiento del objeto a las coordenadas x e y
 * @param {Number} x 
 * @param {Number} y 
 */
